...
<div class="container-fluid mt-5 mb-5">
	<ul class="nav nav-pills row justify-content-center">
		<li class="nav-item col-2">
			<a class="nav-link active" aria-current="page" href="/user/signup/general">일반회원</a>
		</li>
		<li class="nav-item col-2">
			<a class="nav-link" href="/user/signup/business">사업자 회원</a>
		</li>
	</ul>
</div>
<div class="container-fluid">
	<div class="row">
		<form class="offset-md-4 col-md-4" action="/user/insert/general" method="post">
