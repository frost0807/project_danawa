...
<div class="container-fluid">
	<div class="row mt-5">
		<div class="offset-md-4 col-md-4">
			<h4 class="text-center mb-5">상품게시물 수정 페이지</h4>
			<form action="/posting/insert" method="post" enctype="multipart/form-data">
				<div class="row mb-4">
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="itemId" value="${posting.itemId}">
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="title" value="${posting.title}">
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="content" value="${posting.content}">
					</div>
				</div>
				<div class="row">
					<div class="col-md-2">
